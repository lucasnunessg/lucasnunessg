...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=500&size=24&duration=3000&pause=1000&color=00F7FF&center=true&vCenter=true&width=700&lines=Backend+Engineer;Especialista+em+Node.js+e+NestJS;Apaixonado+por+Arquitetura+e+Escalabilidade+🚀" />
...
### Desenvolvedor Backend | Foco em Arquitetura, Performance e Escalabilidade 🚀
...
<img src="https://skillicons.dev/icons?i=ts,nodejs,nestjs,react,docker,mysql,python" />
...
- **Backend Engineering**: Node.js, NestJS, TypeScript, APIs RESTful, Arquitetura em Camadas.
- **Banco de Dados**: MySQL, Modelagem de Dados, Otimização de Queries.
- **Infraestrutura & DevOps**: Docker, Versionamento com Git.
- **Frontend**: React, TypeScript.
- **Boas Práticas**: Clean Code, SOLID, Testes Unitários.
...
- No meu tempo livre, gosto de jogar video games, assistir séries e futebol.
...
<img src="https://komarev.com/ghpvc/?username=lucasnunessg&color=blueviolet&style=flat" alt="Profile Views">
<img src="https://img.shields.io/github/followers/lucasnunessg?style=social" alt="GitHub Followers">
